...
export default function PurchaseOrder({ isOpen, onClose, taxes, onTaxUpdate }) {
  // ─── List state ───────────────────────────────────────────────────────────
          ...
          <div className={styles.invoiceGridContainer}>
            {loading ? (
              ...
              <div className={styles.emptyState}>
                ...
                <p>{searchTerm ? 'Try adjusting your search' : 'Click "New Purchase Order" to create your first purchase order'}</p>
              </div>
            )}
          </div>
        </div>
